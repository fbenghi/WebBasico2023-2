// Carrega módulos
const http = require('http');       // Tratamento de requisições HTTP
const express = require('express'); // Facilita o uso do HTTP
const fs = require('fs');           // File System => Manipulação de arquivos
