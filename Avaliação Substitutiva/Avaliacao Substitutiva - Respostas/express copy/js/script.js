...
const carregarValores = function()
{

    let valores = ""
    const elementoHtmlValores = document.getElementById("paginaValores");

    for(let key in json)
    {   
        valores +=
        '<h3>' + json[key]['titulo'] + '</h3>' +
        '<p>' + json[key]['descricao'] + '</p>';
    }

    elementoHtmlValores.innerHTML = valores;
}
